...
export const constitutionalArticles: Article[] = [
  {
    id: '1',
    number: '14',
  ...
  { number: 'IPC 363', title: 'Punishment for kidnapping', description: 'Punishment for kidnapping any person from India or from lawful guardianship.' },
  { number: 'IPC 364A', title: 'Kidnapping for ransom', description: 'Kidnapping or abducting a person to demand ransom, with threat to cause death or hurt.' },
  { number: 'IPC 366', title: 'Kidnapping or abducting a woman to compel her marriage', description: 'Kidnapping or abducting a woman to compel marriage or force illicit intercourse.' },
  // Extortion
  { number: 'IPC 384', title: 'Punishment for extortion', description: 'Putting a person in fear of injury to dishonestly induce delivery of property.' },
  { number: 'IPC 386', title: 'Extortion by putting a person in fear of death or grievous hurt', description: 'Aggravated extortion by threat of death or grievous hurt.' },
  // Stalking and voyeurism
  { number: 'IPC 354D', title: 'Stalking', description: 'Following, contacting, or monitoring a woman despite disinterest, including online monitoring.' },
  { number: 'IPC 354C', title: 'Voyeurism', description: 'Watching or capturing the image of a woman engaging in a private act without consent.' },
  { number: 'IT Act 66E', title: 'Violation of privacy', description: 'Capturing, publishing, or transmitting the image of a private area of a person without consent.' },
  // Dowry
  { number: 'IPC 304B', title: 'Dowry death', description: 'Death of a woman within seven years of marriage connected with cruelty or harassment for dowry.' },
  { number: 'DP Act 3', title: 'Dowry Prohibition Act, Section 3', description: 'Penalty for giving or taking dowry.' },
  // Rash and negligent driving
  { number: 'IPC 279', title: 'Rash driving or riding on a public way', description: 'Driving or riding so rashly or negligently as to endanger human life.' },
  { number: 'IPC 337', title: 'Causing hurt by act endangering life or personal safety', description: 'Causing hurt by a rash or negligent act endangering life or safety of others.' },
  { number: 'IPC 338', title: 'Causing grievous hurt by act endangering life or personal safety', description: 'Causing grievous hurt by a rash or negligent act endangering life or safety of others.' },
];
